                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        final result = await Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => ChooseInvoiceScreen(
                                      customerId:
                        ...
                        if (result != null) {
                          if (context.mounted) {
                            Provider.of<ReportProvider>(context, listen: false)
                                .setInvoice(result['id'], result['number'],
                                    result['nominal']);
                          }
                        }
                      },
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  provider.selectedInvoiceId == 0
                                      ? 'Pilih Invoice'
                                      : provider.selectedInvoiceNumber
                                          .toString(),
                                  style: TextStyle(
                                    fontSize: 14,
                                    fontFamily: FontColor.fontPoppins,
                                ...
                                provider.selectedInvoiceId != 0
                                    ? Text(
                                        'Rp ${Util.convertToIdr(provider.selectedInvoiceNominal, 0)}',
                                        style: TextStyle(
                                          fontSize: 14,
                                          fontFamily: FontColor.fontPoppins,
                                          fontWeight: FontWeight.w400,
                        ...
                        ? TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    ...
                                    fontWeight: FontWeight.w400,
                                    color:
                                        FontColor.black.withValues(alpha: 0.7),
                                    fontSize: 14),
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(10),
                                  borderSide: const BorderSide(
