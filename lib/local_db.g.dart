    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `LocationModel` (`id` INTEGER, `latitude` TEXT NOT NULL, `longitude` TEXT NOT NULL, `createdAt` TEXT NOT NULL, PRIMARY KEY (`id`))');
...
class _$LocationDao extends LocationDao {
  ...
  @override
  Future<List<LocationModel>> getCacheLocation() async {
    return _queryAdapter.queryList('SELECT * FROM LocationModel',
  ...
  Future<void> clearCache() async {
    await _queryAdapter.queryNoReturn('DELETE FROM LocationModel');
  }

  @override
  Future<void> addLocation(LocationModel location) async {
    await _locationModelInsertionAdapter.insert(
